...
export function MobileNav() {
  ...
  return (
    <nav
      className="border-border/70 bg-card/95 safe-pb sticky bottom-0 z-40 border-t backdrop-blur md:hidden"
          ...
          return (
            <li key={tab.href} className="min-w-0 flex-1">
              ...
              >
                ...
                {showReq && (
                  <span className="bg-primary text-primary-foreground absolute right-1 top-0 grid h-4 min-w-4 place-items-center rounded-full px-1 text-[9px] font-bold">
